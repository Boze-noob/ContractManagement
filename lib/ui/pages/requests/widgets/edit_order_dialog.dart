...
class _EditOrderDialogState extends State<EditOrderDialog> {
  ...
  @override
  void initState() {
    //TODO add payment option from orderModel
        ...
        child: BlocListener<OrderBloc, OrderState>(
          listener: (context, state) {
            if (state.status == OrderStateStatus.submitSuccessful) {
              print('edit is successgul---------------');
              widget.orderEdited;
            }
          },
          child: BlocBuilder<OrderBloc, OrderState>(
            builder: (context, orderState) {
              print('Sender value is -----------------' + orderState.orderModel.senderName);
              ...
              return CustomDialog(
                buttonText: 'Submit',
                onButtonPressed: () => context.orderBloc.add(OrderSubmitUpdateEvent()),
                child: Expanded(
                  child: Padding(
