  ...
  static AppThemeData get light {
    return AppThemeData(
      ...
      theme: ThemeData(
        ...
        primaryColor: const Color(0xFFFEBD2F),
        ...
        toggleableActiveColor: const Color(0xFFFEBD2F),
        ...
        bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          ...
          selectedItemColor: Color(0xFFFEBD2F),
          selectedIconTheme: IconThemeData(size: 22, color: Color(0xFFFEBD2F)),
